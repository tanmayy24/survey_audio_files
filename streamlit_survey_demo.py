...
with survey.pages(len(audio_samples) + 1) as page:
    ...
    if page.current == 0:
        ...
        You will hear one audio sample per question and rate how well it matches the given text description, with a total of 15 audio samples. Since there are multiple models, you will hear multiple audio samples of the same description, as they are generated by different models.
